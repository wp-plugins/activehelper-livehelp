...
function activeHelper_liveHelp_updateDatabase($database_version, $plugin_version) {
  ...
  if ($database_version == "3.0.0") {
   ...
   if ($database_version == "3.1.5") {
     
     $database_version = "3.2.0";
      
   }
   
   if ($database_version == "3.2.0") {
     
     $database_version = "3.2.2";
      
   }
   
    if ($database_version == "3.2.2") {
...
if ($database_version == "3.8.0") {
  ...
  if ($database_version == "3.9.0") {                  
       $database_version = "3.9.5";      
     } 
	 
  if ($database_version == "3.9.5") {                  
       $database_version = "3.9.6";      
     } 
 }
