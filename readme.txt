...
Direct Installation:
1. Go to the section plugins on the Wordpress admin dashboard.
2. Click on "add new" option at the top.
3. Search "activehelper live chat"  on the search option available.
...
= 3.6.0 =
* New Absolute Position option
* Unanswered Chats report updated.
* Failed Chats report updated.
* Monthly and Weekly statistics section.
* Issue on the tracking script generation fixed
