...
= 3.2.0 =
* New unanswered chat report
* Improved Auto start invitation
* Enhanced Dashboard
* Core security update
* Other small improvements and bug fixes
...
= 2.7.4 =
* Fixed database prefix on the installation
* Fixed status indicator space on iPhone/iPad
* Core security update
* Other small improvements and bug fixes.

= 2.7.3 =
* New reset setting button on Server settings 
* New option to update without delete the configuration files
* Fixed scroll issue on Chrome 21.0.1180.60
* Fixed domain ID issue on the tracking script
* Fixed welcome message display problem on IE and Safari
* Fixed delete domain issue
* Fixed issue on the department name with &
* Other small improvements and bug fixes.
...
= 2.7.0 =
* New Support panel Mobile for iPhone/iPad.
* New Support panel Mobile for Android.
* New Support panel Mobile for BlackBerry PlayBook.
* New country restriction.
* Web chat messages sound alert.
* Core security update.
...
= 3.5.0 =
ActiveHelper LiveHelp System 3.5 is full of enhancements and bug fixes, including a new administrative options. Upgrade today!

NOTE : We strongly suggest to do a manual backup of important configuration files before to upgrade a production site, please read and follow the guide below : 
http://www.activehelper.com/support/left-content-layout/37-general-discussion-wordpress/11898-steps-to-do-a-successful-upgrade-please-read
